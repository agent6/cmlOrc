...
urlpatterns = [
    ...
    path("servers/<int:pk>/maintenance/", views.server_maintenance, name="server_maintenance"),
    ...
    path("pool/metrics/snapshot/", views.pool_metrics_snapshot, name="pool_metrics_snapshot"),
